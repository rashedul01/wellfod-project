...
<section class="checkout">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>state :</span>
            <input type="text" name="state" required placeholder="Nikunja">
         </div>
         <div class="inputBox">
            <span>country :</span>
         ...
         <div class="inputBox">
            <span>pin code :</span>
            <input type="number" min="0" name="pin_code" required placeholder="123...">
         </div>
      </div>
     <button value="order now" class="btn" name="order_btn"> <a href="./trackorder.php">Order Now</a></button>
